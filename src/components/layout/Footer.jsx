        ...
        <footer className="py-6 bg-white border-t border-gray-200">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="mt-4 pt-4 border-t border-gray-200 text-center text-sm text-gray-500">
                    <p>Developed by <a href="https://sufikhan.com/" target="_blank" rel="noopener noreferrer" title="Sufi Khan Sulaiman - 20+ years of building scalable Ecommerce solutions" className="text-purple-600 hover:text-purple-700 transition-colors">Sufi Khan Sulaiman</a>. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
